    ...
    public partial class UserSignup : System.Web.UI.Page
    {
        ...
        bool checkMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT*from[dbo].[member_master]where member_id='" + TextBox8.Text.Trim() + "';", con);
        ...
        void signUpNewUser()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master" +
